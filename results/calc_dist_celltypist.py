...
distance_matrix_celltypist = pd.read_csv("./results_celltypist/dist_df.csv", index_col=0)
celltypes = []
...
results_dict = joblib.load('./results_celltypist/results_celltypist_dict.pickle')
...
orig_index_fold_0 = cv[0]['test']
true_labels_fold_1 = celltypes_celltypist[cv[1]['test']]
orig_index_fold_1 = cv[1]['test']
true_labels_fold_2 = celltypes_celltypist[cv[2]['test']]
orig_index_fold_2 = cv[2]['test']
true_labels_fold_3 = celltypes_celltypist[cv[3]['test']]
orig_index_fold_3 = cv[3]['test']
true_labels_fold_4 = celltypes_celltypist[cv[4]['test']]
orig_index_fold_4 = cv[4]['test']

ray.init()

@ray.remote
def get_distance_matrix_celltypist(true_labels, orig_index, keys_fold, fold_str, fold_num, distance_matrix_celltypist):
...
cv0 = get_distance_matrix_celltypist.remote(true_labels_fold_0, orig_index_fold_0, keys_fold_0, 'fold_0', 0, distance_matrix_celltypist)
cv1 = get_distance_matrix_celltypist.remote(true_labels_fold_1, orig_index_fold_1, keys_fold_1, 'fold_1', 1, distance_matrix_celltypist)
cv2 = get_distance_matrix_celltypist.remote(true_labels_fold_2, orig_index_fold_2, keys_fold_2, 'fold_2', 2, distance_matrix_celltypist)
cv3 = get_distance_matrix_celltypist.remote(true_labels_fold_3, orig_index_fold_3, keys_fold_3, 'fold_3', 3, distance_matrix_celltypist)
cv4 = get_distance_matrix_celltypist.remote(true_labels_fold_4, orig_index_fold_4, keys_fold_4, 'fold_4', 4, distance_matrix_celltypist)
...
results_cv.to_csv('./results_celltypist/results_celltypist_dists.csv')