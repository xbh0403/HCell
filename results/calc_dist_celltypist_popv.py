...
results_dict = joblib.load('./results_celltypist/results_crossdataset_celltypist_dict.pickle')
...
true_labels = dataset_popv.obs['cell_type'].values

orig_index = dataset_popv.obs.index
...
cv0 = get_distance_matrix_celltypist.remote(true_labels, orig_index, keys_fold_0, 'fold_0', 0, distance_matrix_celltypist)
cv1 = get_distance_matrix_celltypist.remote(true_labels, orig_index, keys_fold_1, 'fold_1', 1, distance_matrix_celltypist)
cv2 = get_distance_matrix_celltypist.remote(true_labels, orig_index, keys_fold_2, 'fold_2', 2, distance_matrix_celltypist)
cv3 = get_distance_matrix_celltypist.remote(true_labels, orig_index, keys_fold_3, 'fold_3', 3, distance_matrix_celltypist)
cv4 = get_distance_matrix_celltypist.remote(true_labels, orig_index, keys_fold_4, 'fold_4', 4, distance_matrix_celltypist)
...
results_cv.to_csv('./results_celltypist/results_crossdataset_celltypist_dists.csv')