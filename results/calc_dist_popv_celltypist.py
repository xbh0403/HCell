...
results_dict = joblib.load('./results_popv/results_crossdataset_popv_dict.pickle')
...
true_labels = dataset_celltypist.obs['Manually_curated_celltype'].values

orig_index = dataset_celltypist.obs.index
...
cv0 = get_distance_matrix.remote(true_labels, orig_index, keys_fold_0, 'fold_0', 0, distance_matrix_popv)
cv1 = get_distance_matrix.remote(true_labels, orig_index, keys_fold_1, 'fold_1', 1, distance_matrix_popv)
cv2 = get_distance_matrix.remote(true_labels, orig_index, keys_fold_2, 'fold_2', 2, distance_matrix_popv)
cv3 = get_distance_matrix.remote(true_labels, orig_index, keys_fold_3, 'fold_3', 3, distance_matrix_popv)
cv4 = get_distance_matrix.remote(true_labels, orig_index, keys_fold_4, 'fold_4', 4, distance_matrix_popv)
...
results_cv.to_csv('./results_popv/results_crossdataset_popv_dists.csv')