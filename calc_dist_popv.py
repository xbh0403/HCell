...
distance_matrix_popv = helper_fns.get_dist_df(list_num_ct=list_num_ct, g=graph_popv)
celltypes = []
...
# load cv
cv = joblib.load('results_popv/cv_popv.pkl')
...
@ray.remote
def get_distance_matrix(true_labels, keys_fold, fold_str, fold_num, distance_matrix):
...
cv0 = get_distance_matrix.remote(true_labels_fold_0, keys_fold_0, 'fold_0', 0, distance_matrix_popv)
cv1 = get_distance_matrix.remote(true_labels_fold_1, keys_fold_1, 'fold_1', 1, distance_matrix_popv)
cv2 = get_distance_matrix.remote(true_labels_fold_2, keys_fold_2, 'fold_2', 2, distance_matrix_popv)
cv3 = get_distance_matrix.remote(true_labels_fold_3, keys_fold_3, 'fold_3', 3, distance_matrix_popv)
cv4 = get_distance_matrix.remote(true_labels_fold_4, keys_fold_4, 'fold_4', 4, distance_matrix_popv)
...
results_cv.to_csv('./results_popv/dist_df_popv.csv')